/**
 * Full Name: Manthan Amitkumar Shah
 * StudentID: 100776892
 * 
 * Full Name: Michai Pryce
 * 
...
((core) =>
{
    ...
    /**
     *  Show / Hide pages based on user is logged in or not.
     */
    function toggleLogin()
    {
      ...
      // Show TaskList to navbar if user is logged in
        $(`<li class="nav-item">
    ...
    /**
     * Auth-guard checks for if the user is logged in or not. 
     * If user not logged in then it will redirect to login page.  
     */
    function authGuard()
    {
      if(!sessionStorage.getItem("user"))
    ...
    /**
     * Set the callback function for active link.
     */
    function ActiveLinkCallBack(activeLink)
    {
      switch (activeLink) 
      {
        ...
        case "task-list": return DisplayTaskList; // set the callback function for the TaskList
